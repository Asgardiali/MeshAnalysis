function varargout = doolittleInsertData_GUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @doolittleInsertData_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @doolittleInsertData_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function doolittleInsertData_GUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = doolittleInsertData_GUI_OutputFcn(hObject, eventdata, handles) 
